...
public class ElasticsearchConfig {
    ...
    private String esCluster = "192.168.66.66:9300,192.168.66.66:9301";
   ...
   @Bean
    public Client client_single() {
        ...
        try {
            ...
            client.addTransportAddress(new TransportAddress(InetAddress.getByName("39.107.94.159"), 9300));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return client;
